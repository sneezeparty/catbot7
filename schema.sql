...
CREATE TABLE public.profile (
    ...
    dark_market_active boolean DEFAULT true,
    ...
    "cat_Terminator" integer DEFAULT 0,
    ...
    thats_rude boolean DEFAULT false,
    ...
    catslots boolean DEFAULT false,
    win_catslots boolean DEFAULT false,
    big_win_catslots boolean DEFAULT false,
    paradoxical_catslots boolean DEFAULT false,
    catslots_spins integer DEFAULT 0,
    catslots_wins integer DEFAULT 0,
    catslots_big_wins integer DEFAULT 0,
    catslots_coins_bet bigint DEFAULT 0,
    catslots_coins_won bigint DEFAULT 0,
    catslots_bonus_triggers integer DEFAULT 0,
    catslots_bonus_coins_won bigint DEFAULT 0,
    catslots_bonus_spins_total integer DEFAULT 0,
    egirl_party boolean DEFAULT false,
    egirl_party_max boolean DEFAULT false,
    ...
    combo_stack integer DEFAULT 0,
    challenge_quest character varying(30) DEFAULT ''::character varying,
    challenge_progress integer DEFAULT 0,
    challenge_cooldown bigint DEFAULT 0,
    challenge_reward smallint DEFAULT 0,
    reminder_challenge integer DEFAULT 0,
    gift3_recipients text DEFAULT ''::text,
    ...
    unlocked_aches jsonb DEFAULT '[]'::jsonb NOT NULL,
    discovered_cats jsonb DEFAULT '[]'::jsonb NOT NULL,
    store_purchased_rarities jsonb DEFAULT '[]'::jsonb NOT NULL,
    extra_quest character varying(30) DEFAULT ''::character varying NOT NULL,
    extra_progress smallint DEFAULT 0 NOT NULL,
    extra_cooldown bigint DEFAULT 1 NOT NULL,
    ...
    last_job_time bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE public."user" (
    ...
    daily_catch_streak integer DEFAULT 0,
